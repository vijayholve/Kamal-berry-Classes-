            ...
            <div className="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
              <div className="row">
                <div className="col-lg-12">
                  ...
                  <p><strong >✅ 100% Internship And Placement  Guarantee!</strong> We ensure every student gets job-ready with real-world projects, industry exposure, and career support.</p>
                </div>
                <div className="col-lg-12">
                </div>
              </div>
