        ...
        <nav className="main-nav navbar">
          ...
          <div className={`nav-links ${isMobileMenuOpen ? "open" : ""}`} onMouseLeave={handleMenuClose}>
            <ul className="nav-menu">
              ...
              <li onMouseEnter={handleMenuOpen} onMouseLeave={handleMenuClose}>
                <Button
                ...
                >
                  <MenuItem onMouseEnter={(e) => handleSubMenuOpen(e, "advanced")} onMouseLeave={handleSubMenuClose}>
                    Advanced Courses
                  </MenuItem>
                  <MenuItem onMouseEnter={(e) => handleSubMenuOpen(e, "beginner")} onMouseLeave={handleSubMenuClose}>
                    Beginner Courses
                  </MenuItem>
                </Menu>
                {activeCategory && (
