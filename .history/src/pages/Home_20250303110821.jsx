        ...
        <div className="row">
          <div className="col-lg-6 align-self-center">
            <div className="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
              <div className="row">
                <div className="col-lg-12">
                  <h6>Kamal Berry =It </h6>
                  <h2>Boost Your Career with Expert Guidance</h2>
                  <p>Join <strong>Kamal Berry =It </strong> to master in-demand skills with expert mentorship and hands-on training. Whether you prefer <strong>online or offline learning</strong>, we provide a flexible environment to suit your needs.</p>
